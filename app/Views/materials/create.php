...
<div class="d-flex justify-between items-center mb-4">
    ...
    <a href="<?= url('materials') ?>" class="btn btn-secondary">&larr; Retour</a>
</div>
    ...
    <form method="post" action="<?= url('materials/create') ?>">
        ...
        <div class="form-group mt-4">
            ...
            <textarea id="notes" name="notes" rows="4"
                placeholder="Informations complémentaires..."><?= e($material['notes'] ?? '') ?></textarea>
        </div>

        <div class="d-flex justify-between items-center mt-4">
            <button type="submit" class="btn btn-primary">Ajouter le matériel</button>
            <a href="<?= url('materials') ?>" class="text-muted" style="font-size: 0.9rem;">Annuler</a>
        </div>
    </form>
</div>
